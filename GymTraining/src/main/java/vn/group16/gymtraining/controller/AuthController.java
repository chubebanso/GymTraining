...
import vn.group16.gymtraining.dto.LoginDTO;
import vn.group16.gymtraining.dto.ResLoginDTO;
import vn.group16.gymtraining.service.UserService;
import vn.group16.gymtraining.util.SecurityUtil;
import vn.group16.gymtraining.util.annotation.APIMessage;
...
public class AuthController {
        ...
        @Value("${chubebanso.jwt.refresh-token-validity-in-seconds}")
        ...
        public ResponseEntity<Object> login(@Valid @RequestBody LoginDTO loginDto) {
                ...
                if (currentUser != null) {
                        ...
                        res.setRole(currentUser.getRole());
                }
